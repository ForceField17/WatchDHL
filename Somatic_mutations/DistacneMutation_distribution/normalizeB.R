...
cumAge3 <- cumAge3 + geom_errorbar(data=All_Mut,width=0,size=0.2, aes(x=Distance,ymin=xxxx, ymax=yyyy,color=V1),alpha=0.1)
...
ggsave(file="Fig3a_Slide_mergeB_normalized_MB.pdf", plot=figure_1,bg = 'white', width = 20, height = 10, units = 'cm', dpi = 600)
