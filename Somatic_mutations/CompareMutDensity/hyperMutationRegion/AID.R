...
plot.table$fraction <- plot.table$WRCY/plot.table$mutation*100
...
NAN_plot<- NAN_plot +ylab("percentage of WRCY mutation") +xlab(NULL)
...
ggsave(file="ExtFig16d_All_AID.pdf", plot=figure_2,bg = 'white', width =14, height = 10, units = 'cm', dpi = 600)
