...
ggsave(file="Figure2c_1.pdf", plot=figure_1,bg = 'white', width = 22, height = 10, units = 'cm', dpi = 600)
...
figure_1<-rbind(ggplotGrob(histology.plot),size="first")
ggsave(file="Figure2c_2.pdf", plot=figure_1,bg = 'white',  width = 22, height = 10, units = 'cm', dpi = 600)
