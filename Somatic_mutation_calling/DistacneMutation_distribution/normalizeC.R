...
FL <-   read.delim("Slide_H3K27ac/mutDens_FL.txt",sep = c("\t"," "),header = F)
FL2 <-  read.delim("Slide_H3K27ac/mutDens_FL_nege.txt",sep = c("\t"," "),header = F)
DHL <-  read.delim("Slide_H3K27ac/mutDens_DHL.txt",sep = c("\t"," "),header = F)
DHL2 <- read.delim("Slide_H3K27ac/mutDens_DHL_nege.txt",sep = c("\t"," "),header = F)
...
FL$Burden.avg <- rowMeans( cbind( (FL$P1/FL$interval/FL$P1t*100*1000000), (FL$P2/FL$interval/FL$P2t*100*1000000), (FL$P6/FL$interval/FL$P6t*100*1000000), (FL$P7/FL$interval/FL$P7t*100*1000000), (FL$P8/FL$interval/FL$P8t*100*1000000), (FL$P8.b/FL$interval/FL$P8.bt*100*1000000)))
FL$Burden.sd  <- rowSds(  cbind( (FL$P1/FL$interval/FL$P1t*100*1000000), (FL$P2/FL$interval/FL$P2t*100*1000000), (FL$P6/FL$interval/FL$P6t*100*1000000), (FL$P7/FL$interval/FL$P7t*100*1000000), (FL$P8/FL$interval/FL$P8t*100*1000000), (FL$P8.b/FL$interval/FL$P8.bt*100*1000000)))

FL2$Burden.avg <- rowMeans( cbind( (FL2$P1/FL2$interval/FL2$P1t*100*1000000), (FL2$P2/FL2$interval/FL2$P2t*100*1000000), (FL2$P6/FL2$interval/FL2$P6t*100*1000000), (FL2$P7/FL2$interval/FL2$P7t*100*1000000), (FL2$P8/FL2$interval/FL2$P8t*100*1000000), (FL2$P8.b/FL2$interval/FL2$P8.bt*100*1000000)))
FL2$Burden.sd  <- rowSds(  cbind( (FL2$P1/FL2$interval/FL2$P1t*100*1000000), (FL2$P2/FL2$interval/FL2$P2t*100*1000000), (FL2$P6/FL2$interval/FL2$P6t*100*1000000), (FL2$P7/FL2$interval/FL2$P7t*100*1000000), (FL2$P8/FL2$interval/FL2$P8t*100*1000000), (FL2$P8.b/FL2$interval/FL2$P8.bt*100*1000000)))

DHL$Burden.avg <- rowMeans( cbind( (DHL$P1/DHL$interval/DHL$P1t*100*1000000), (DHL$P2/DHL$interval/DHL$P2t*100*1000000), (DHL$P6/DHL$interval/DHL$P6t*100*1000000), (DHL$P7/DHL$interval/DHL$P7t*100*1000000), (DHL$P8/DHL$interval/DHL$P8t*100*1000000)))
DHL$Burden.sd  <- rowSds(  cbind( (DHL$P1/DHL$interval/DHL$P1t*100*1000000), (DHL$P2/DHL$interval/DHL$P2t*100*1000000), (DHL$P6/DHL$interval/DHL$P6t*100*1000000), (DHL$P7/DHL$interval/DHL$P7t*100*1000000), (DHL$P8/DHL$interval/DHL$P8t*100*1000000)))

DHL2$Burden.avg <- rowMeans( cbind( (DHL2$P1/DHL2$interval/DHL2$P1t*100*1000000), (DHL2$P2/DHL2$interval/DHL2$P2t*100*1000000), (DHL2$P6/DHL2$interval/DHL2$P6t*100*1000000), (DHL2$P7/DHL2$interval/DHL2$P7t*100*1000000), (DHL2$P8/DHL2$interval/DHL2$P8t*100*1000000)))
DHL2$Burden.sd  <- rowSds(  cbind( (DHL2$P1/DHL2$interval/DHL2$P1t*100*1000000), (DHL2$P2/DHL2$interval/DHL2$P2t*100*1000000), (DHL2$P6/DHL2$interval/DHL2$P6t*100*1000000), (DHL2$P7/DHL2$interval/DHL2$P7t*100*1000000), (DHL2$P8/DHL2$interval/DHL2$P8t*100*1000000)))
...
cumAge <- cumAge+ggtitle(NULL)+xlab("H3K27ac")+ylab('Average proportion of somatic mutations (%/Mbp)')+
  scale_y_continuous(expand=c(0,0),limits=c(0,0.71),breaks = seq(0,1,0.1)) +
...
#raw data preprocessing
FL <-   read.delim("Slide_H3K4me3/mutDens_FL.txt",sep = c("\t"," "),header = F)
FL2 <-  read.delim("Slide_H3K4me3/mutDens_FL_nege.txt",sep = c("\t"," "),header = F)
DHL <-  read.delim("Slide_H3K4me3/mutDens_DHL.txt",sep = c("\t"," "),header = F)
DHL2 <- read.delim("Slide_H3K4me3/mutDens_DHL_nege.txt",sep = c("\t"," "),header = F)
...
cumAge2 <- cumAge2 + geom_vline(xintercept = 0,color="grey",size=0.5,linetype=2)
cumAge2 <- cumAge2 + geom_line(data=All_Mut,aes(x=Distance,y=Burden.avg,color=V1), alpha=1,size=1)
...
cumAge2<- cumAge2 +theme(panel.background=element_rect(fill='transparent',color='transparent'),plot.margin=unit(c(2,0.9,2,1),'lines'),
                         ...
                         axis.title.x=element_text(size=14,vjust=0,hjust=0.5,face="plain",color='black'),axis.title.y=element_blank())
cumAge2 <- cumAge2+ggtitle(NULL)+xlab("Distance to H3K4me3")+ylab('Average proportion of somatic mutations (%/Mbp)')+
  scale_y_continuous(expand=c(0,0),limits=c(0,0.71),breaks = seq(0,1,0.1)) +
  scale_x_continuous(expand=c(0,0),limits=c(-100000,100000),breaks = seq(-200000,200000,40000))
table2 <- data.frame(c(0,0),c(0,0.0088))
colnames(table2) <- c("Xaxis","Yaxis")
...
#raw data preprocessing
FL <-   read.delim("Slide_H3K4me1/mutDens_FL.txt",sep = c("\t"," "),header = F)
FL2 <-  read.delim("Slide_H3K4me1/mutDens_FL_nege.txt",sep = c("\t"," "),header = F)
DHL <-  read.delim("Slide_H3K4me1/mutDens_DHL.txt",sep = c("\t"," "),header = F)
DHL2 <- read.delim("Slide_H3K4me1/mutDens_DHL_nege.txt",sep = c("\t"," "),header = F)
colnames(FL) <-   c("V1","V2","Distance","P1","P2","P4","P5","P6","P7","P8","P8.b","P9","interval","P1t","P2t","P4t","P5t","P6t","P7t","P8t","P8.bt","P9t","V23")
colnames(FL2) <-   c("V1","V2","Distance","P1","P2","P4","P5","P6","P7","P8","P8.b","P9","interval","P1t","P2t","P4t","P5t","P6t","P7t","P8t","P8.bt","P9t","V23")
colnames(DHL) <-  c("V1","V2","Distance","P1","P2","P4","P5","P6","P7","P8","P8.b","P9","interval","P1t","P2t","P4t","P5t","P6t","P7t","P8t","P9t","V22")
colnames(DHL2) <- c("V1","V2","Distance","P1","P2","P4","P5","P6","P7","P8","P8.b","P9","interval","P1t","P2t","P4t","P5t","P6t","P7t","P8t","P9t","V22")
...
cumAge3 <- cumAge3 + geom_vline(xintercept = 0,color="grey",size=0.5,linetype=2)
cumAge3 <- cumAge3 + geom_line(data=All_Mut,aes(x=Distance,y=Burden.avg,color=V1), alpha=1,size=1)
...
cumAge3<- cumAge3 +theme(panel.background=element_rect(fill='transparent',color='transparent'),plot.margin=unit(c(2,2,2,1),'lines'),
                         ...
                         axis.text.x=element_text(size=12,angle=30,vjust=1,hjust=1,face='bold',color='black'),axis.text.y=element_blank(),
                         axis.title.x=element_text(size=14,vjust=0,hjust=0.5,face="plain",color='black'),axis.title.y=element_blank())
cumAge3 <- cumAge3+ggtitle(NULL)+xlab("Distance to H3K4me1")+ylab('Average proportion of somatic mutations (%/Mbp)')+
  scale_y_continuous(expand=c(0,0),limits=c(0,0.71),breaks = seq(0,1,0.1)) +
  scale_x_continuous(expand=c(0,0),limits=c(-100000,100000),breaks = seq(-200000,200000,40000))
table2 <- data.frame(c(0,0),c(0,0.0088))
colnames(table2) <- c("Xaxis","Yaxis")
...
ggsave(file="Slide_mergeC_normalized_MB.pdf", plot=figure_1,bg = 'white', width = 34, height = 14, units = 'cm', dpi = 600)
