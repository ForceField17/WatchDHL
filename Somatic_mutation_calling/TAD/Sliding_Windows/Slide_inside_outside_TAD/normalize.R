...
cumAge <- cumAge+ggtitle(NULL)+xlab("Distance to TSS (bp)")+ylab('Average proportion of somatic mutations (%/Mbp)')+
  scale_y_continuous(expand=c(0,0),limits=c(0,0.7),breaks = seq(0,0.36,0.05)) +
...
ggsave(file="normalized_MB_P12678.pdf", plot=figure_1,bg = 'white', width = 22, height = 14, units = 'cm', dpi = 600)
