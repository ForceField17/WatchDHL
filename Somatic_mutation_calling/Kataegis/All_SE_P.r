...
Mut <- read.csv("./kateagis_DHL_30.final.txt",header = T,sep = "\t")
...
Mut_ <- read.csv("./kateagis_FL_30.final.txt",header = T,sep = "\t")
...
ggsave(file="./merge.20.SE.pdf", plot=figure_1,bg = 'white', width = 34, height =  10, units = 'cm', dpi = 600)
...
figure_1$heights[panels][1] <- unit(1,'null')
figure_1$heights[panels][2] <- unit(1,'null')
ggsave(file="./merge.chr16.20.SE.pdf", plot=figure_1,bg = 'white', width = 34, height =  10, units = 'cm', dpi = 600)
...
figure_1$heights[panels][1] <- unit(1,'null')
figure_1$heights[panels][2] <- unit(1,'null')
ggsave(file="./merge.chr2.20.SE.pdf", plot=figure_1,bg = 'white', width = 34, height =  10, units = 'cm', dpi = 600)
