setwd("/Users/songdong/Dropbox/Dropbox/DLBCL/main_figures/Mutation_Distribution/Pall_DistanceMutDensity/kata/")
...
Mut <- read.csv("./kateagis_DHL_20.final.txt",header = T,sep = "\t")
...
Mut_ <- read.csv("./kateagis_FL_20.final.txt",header = T,sep = "\t")
...
ggsave(file="./merge.20.HIS.pdf", plot=figure_1,bg = 'white', width = 34, height =  12, units = 'cm', dpi = 600)
...
Mut <- read.csv("./kateagis_FL_20.final.txt",header = T,sep = "\t")
...
figure_1$heights[panels][1] <- unit(1,'null')
figure_1$heights[panels][2] <- unit(1,'null')
ggsave(file="./merge.chr16.20.HIS.pdf", plot=figure_1,bg = 'white', width = 34, height =  12, units = 'cm', dpi = 600)
