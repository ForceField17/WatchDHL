...
NAN_plot <- NAN_plot + scale_y_continuous(expand=c(0,0),limits=c(0,60),breaks = seq(0,100,10)) 
...
ggsave(file="All_density.pdf", plot=figure_2,bg = 'white', width =14, height = 10, units = 'cm', dpi = 600)
