...
ggsave(file="FL_compartment_P126789.pdf", plot=figure_2,bg = 'white', width =16, height = 14, units = 'cm', dpi = 600)
...
ggsave(file="DHL_compartment_P126789.pdf", plot=figure_2,bg = 'white', width =16, height = 14, units = 'cm', dpi = 600)
