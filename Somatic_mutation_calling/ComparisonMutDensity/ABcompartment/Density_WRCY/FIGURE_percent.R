...
NAN_plot <- NAN_plot + scale_y_continuous(expand=c(0,0),limits=c(0,100),breaks = seq(0,100,20)) 
...
ggsave(file="FL_percent.pdf", plot=figure_2,bg = 'white', width =10, height = 12, units = 'cm', dpi = 600)
...
ggsave(file="DHL_percent.pdf", plot=figure_2,bg = 'white', width =10, height = 12, units = 'cm', dpi = 600)
