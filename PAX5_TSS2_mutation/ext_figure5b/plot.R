...
figure<-cbind(rbind(ggplotGrob(F2a.pLot),ggplotGrob(Part1),ggplotGrob(Part3),ggplotGrob(Part4),ggplotGrob(Part5)),size="last")
...
#grid.draw(figure_1)
ggsave(file="ExtFig5b_landscape_WGS_supported_TSS2_hotspotMut_in_GCB_tumors.pdf", plot=figure,bg = 'white', width = 9.5, height = 9, units = 'cm', dpi = 600)
