...
ggsave(file="./ExtFig5/exp_ZCCHC7_Cell.pdf", plot=figure_2,bg = 'white', width =10, height = 9, units = 'cm', dpi = 600)
...
figure_2<-rbind(ggplotGrob(NAN_plot),size="last")
ggsave(file="./ExtFig5/exp_PAX5_Cell.pdf", plot=figure_2,bg = 'white', width =10, height = 9, units = 'cm', dpi = 600)
...
figure_2<-rbind(ggplotGrob(NAN_plot),size="last")
ggsave(file="./ExtFig5/exp_ZCCHC7_Tumor.pdf", plot=figure_2,bg = 'white', width =10, height = 9, units = 'cm', dpi = 600)
...
figure_2<-rbind(ggplotGrob(NAN_plot),size="last")
ggsave(file="./ExtFig5/exp_PAX5_Tumor.pdf", plot=figure_2,bg = 'white', width =10, height = 9, units = 'cm', dpi = 600)
...
#grid.draw(figure_1)
ggsave(file="./ExtFig5/Integated_landscape.pdf", plot=figure,bg = 'white', width = 28, height = 10, units = 'cm', dpi = 600)
