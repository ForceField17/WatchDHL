...
NAN_plot <- NAN_plot + scale_y_continuous(expand=c(0,0),limits=c(-1.1,2.8),breaks = seq(-10,10,1)) 
...
ggsave(file="AICDA_XXX.pdf", plot=figure_2,bg = 'white', width =10, height = 10, units = 'cm', dpi = 600)
